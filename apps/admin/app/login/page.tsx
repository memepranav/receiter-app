      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          <svg className="absolute inset-0 w-full h-full opacity-10" viewBox="0 0 1200 800" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M0,100 L300,0 L600,150 L900,50 L1200,200" stroke="url(#yellowGradient)" strokeWidth="2" fill="none"/>
            <path d="M0,300 L400,200 L800,350 L1200,250" stroke="url(#yellowGradient)" strokeWidth="1.5" fill="none"/>
            <path d="M200,0 L500,250 L800,100 L1200,300" stroke="url(#yellowGradient)" strokeWidth="1" fill="none"/>
            <path d="M0,500 L300,400 L600,550 L900,450 L1200,600" stroke="url(#yellowGradient)" strokeWidth="2" fill="none"/>
            <path d="M100,700 L400,600 L700,750 L1000,650 L1200,800" stroke="url(#yellowGradient)" strokeWidth="1.5" fill="none"/>
          </svg>
        </div>
        ...
        <div className="absolute top-1/2 right-1/3 w-32 h-32 bg-yellow-400/10 rounded-full blur-2xl opacity-20 animate-pulse" style={{animationDelay: '2s'}}></div>
